...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <table id="dataTableMunicipio" class="display table table-striped table-bordered" style="width:95%">
                <thead>
                    <tr>
                        <th>id</th>
                        <th>Nombre</th>
    ...
    @include('./geolocation/municipio/modalCreateMunicipio')
...
@section('js')
    ...
    <script src="{{ asset('ajax/geolocation/Municipio.js') }}" defer></script>
