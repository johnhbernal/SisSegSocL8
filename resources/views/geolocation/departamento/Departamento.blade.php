...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <table id="dataTableDepartamento" class="display table table-striped table-bordered" style="width:95%">
                <thead>
                    <tr>
                        <th>id</th>
                        <th>Nombre</th>
    ...
    @include('./geolocation/departamento/modalCreateDepartamento')
...
@section('js')
    ...
    <script src="{{ asset('ajax/geolocation/Departamento.js') }}" defer></script>
